    ...
    <article className="condition-hub">
      ...
      <div className="container">
        <Reveal variant="fade-up">
          <span className="eyebrow">JOINT REPLACEMENT & ARTHROPLASTY</span>
        ...
        <Reveal variant="fade-up" delay={80}>
          <nav className="condition-hub__toc">
            ...
            <ul>
              <li><a href="#what-is" data-cursor="link">What is Knee Replacement?</a></li>
              <li><a href="#symptoms" data-cursor="link">Symptoms That May Indicate You Need Surgery</a></li>
              <li><a href="#diagnosis" data-cursor="link">Diagnosis Process</a></li>
              <li><a href="#treatment" data-cursor="link">Treatment Options</a></li>
              <li><a href="#robotic" data-cursor="link">Robotic Knee Replacement</a></li>
              <li><a href="#recovery" data-cursor="link">Recovery Timeline</a></li>
              <li><a href="#decision" data-cursor="link">How to Decide If Surgery Is Right for You</a></li>
